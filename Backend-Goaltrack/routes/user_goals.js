...
router.post("/addgoalStatus", jwtUtil.isAdmin,jsonParser, async (req, res) => {
...
router.get("/:email", jwtUtil.isAdmin,async (req, res) => {
  try {
...
router.get("/:email/:month", jwtUtil.isAdmin,async (req, res) => {
  ...
  router.put("/editgoal", jsonParser, jwtUtil.isAdmin,async (req, res) => {
  ...
  router.put("/editstatus", jsonParser, jwtUtil.isAdmin,async (req, res) => {
